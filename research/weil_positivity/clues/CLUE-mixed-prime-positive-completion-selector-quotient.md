...
Accepted, but now sharply narrowed by [`WP-098`](../findings/WP-098-positive-prime-torus-quotients-preserving-coordinate-observables-cannot-erase-mixed-prime-modes.md), [`WP-099`](../findings/WP-099-passive-positive-auxiliary-elimination-cannot-sparsify-the-mixed-prime-completion.md), [`WP-100`](../findings/WP-100-mixed-prime-product-completion-is-haar-singular-at-the-weil-boundary.md), [`WP-101`](../findings/WP-101-correlations-restore-haar-equivalence-at-critical-diagonal-but-only-below-zygmund-endpoint.md), and [`WP-107`](../findings/WP-107-exact-critical-prime-torus-completions-have-infinite-cylindrical-relative-entropy.md).
...
`WP-107` closes the most canonical information-theoretic nonlinear repair of that correlated escape. For **every** positive completion with the exact critical first-coordinate moments, the KL divergence of each finite prime marginal from product Haar is bounded below by a constant multiple of `sum_{p in P} (log p)^2/p`, using Pinsker plus the total-correlation decomposition. Hence the cylindrical relative entropy diverges as the prime set grows, independently of mixed-prime correlations or global measure class. Marginalization can forget correlations while preserving positivity, but ordinary KL geometry then has infinite critical cost; subtracting that cost would require a new signed/renormalized theorem rather than inherit the KL sign.

The remaining question is therefore genuinely global rather than a hidden positive quotient, a mere singularity escape, or an ordinary finite relative-entropy geometry. A surviving construction may retain a deliberately endpoint-rough mixed-prime sector, use a singular state, change the finite observable/domain or reference geometry before reduction, or form the finite and archimedean sectors nonseparably. Non-passive off-diagonal or other nonlinear reductions remain logically possible, but they must prove their sign independently and cannot inherit it merely from positivity of a hand-built finite-place carrier.