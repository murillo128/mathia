...
Accepted, but now sharply narrowed by [`WP-098`](../findings/WP-098-positive-prime-torus-quotients-preserving-coordinate-observables-cannot-erase-mixed-prime-modes.md) and [`WP-099`](../findings/WP-099-passive-positive-auxiliary-elimination-cannot-sparsify-the-mixed-prime-completion.md).
...
The remaining question is therefore genuinely global rather than a hidden positive quotient: can an independently forced finite--archimedean architecture **retain the mixed-prime sector through the final assembled pairing**, or change the finite observable/domain structure before any passive reduction, so that the exact Weil decomposition emerges only after a single global sign theorem? Non-passive relative/off-diagonal or nonlinear reductions remain logically possible, but they must prove their sign independently and cannot inherit it merely from positivity of the `WP-097` carrier.