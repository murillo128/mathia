...
The adelic solenoid preserves labels, but broad commuting calculi and scalar dilation structures have the wrong compact-resolvent scale. A useful completion must force a non-scalar or relative operator whose arithmetic readout survives matched controls.
