...
## Multiplicative Toeplitz matrices and infinite-polydisc Hardy operators

- Titus Hilberdink, **Determinants of multiplicative Toeplitz matrices**, *Acta Arithmetica* 125:3 (2006), 265–284. DOI: 10.4064/aa125-3-4. Role: explicitly studies matrices whose `(i,j)` entry is a function of the rational ratio `i/j`, including determinant formulas and number-theoretic applications; direct prior-art anchor for the normalized weak-refinement matrix class identified in PC-174.
- Titus Hilberdink, **Multiplicative Toeplitz matrices and the Riemann zeta function**, in *Four Faces of Number Theory*, EMS Series of Lectures in Mathematics 22, European Mathematical Society (2015), 77–122. DOI: 10.4171/142. Role: explicit established connection between multiplicative Toeplitz matrices, functional analysis, and extreme values of the Riemann zeta function; novelty-warning boundary for any PC-174 continuation that inserts a zeta-bearing ratio symbol rather than deriving it from Prime-Circle geometry.
- Kunyu Guo and Fugang Yan, **Toeplitz operators on the Hardy space over the infinite-dimensional polydisc**, *Acta Scientiarum Mathematicarum* 88 (2022), 223–262. DOI: 10.1007/s44146-022-00016-z. Role: identifies infinite multiplicative Toeplitz matrices with Toeplitz operators on `H^2(T^infinity)`, proves a Brown–Halmos-type theorem and symbolic calculus, and shows natural infinite-polydisc Toeplitz algebras contain no nonzero compact operators; primary operator-theoretic prior-art anchor for PC-174.

## Strip Poisson kernels and Fourier positivity

- Thiago Carvalho Corso, **A Generalized Three Lines Lemma in Hardy-like Spaces**, *Complex Analysis and Operator Theory* 20, article 146 (2026). DOI: 10.1007/s11785-026-01997-3. Role: Appendix B gives the strip Poisson kernel `P_y(x) = (1/2) sin(pi y)/(cosh(pi x)-cos(pi y))` and proves its explicit Fourier transform; direct analytic prior-art anchor for the positive factor transform used in PC-191.
- D. V. Widder, **Functions harmonic in a strip**, *Proceedings of the American Mathematical Society* 12:1 (1961), 67–72. DOI: 10.1090/S0002-9939-1961-0132838-8. Role: classical strip Poisson representation cited by Corso; historical potential-theory anchor for PC-191.

## Cyclotomic coefficient sparsity and Fourier-minor boundaries

- Carlo Sanna, **A survey on coefficients of cyclotomic polynomials**, *Expositiones Mathematicae* 40:3 (2022), 469–494. DOI: 10.1016/j.exmath.2022.03.002. arXiv:2111.04034. Role: broad survey of the classical and modern theory of cyclotomic coefficients, gaps, and sparsity; primary prior-art boundary for PC-218's identification of transverse-mask nullity with the number of zero cyclotomic coefficients.
- Igor E. Shparlinski and Laurence P. Wijaya, **On nonzero coefficients of binary cyclotomic polynomials**, *Journal of Number Theory* 271 (2025), 246–258. DOI: 10.1016/j.jnt.2024.11.008. arXiv:2307.07229. Role: explicitly studies `vartheta(n)`, the number of nonzero cyclotomic coefficients, in the binary family; confirms that the statistic governing PC-218's exact rank formula is established cyclotomic coefficient data.
- Maria Loukaki, **Chebotarev's theorem for cyclic groups of order pq and an uncertainty principle**, *Bulletin of the London Mathematical Society* 57:12 (2025), 3841–3856. DOI: 10.1112/blms.70192. Role: modern composite-order Fourier-minor and uncertainty-principle prior art neighboring PC-218's primitive-root evaluation matrix; PC-218 itself uses the stronger project-specific minimal-polynomial relation rather than requiring a composite Chebotarev theorem.
...
## Prime multiplicative character spectra and residue products

- Kaisa Matomäki and Joni Teräväinen, **Products of primes in arithmetic progressions**, *Journal für die reine und angewandte Mathematik (Crelles Journal)* 2024, no. 808 (2024), 193–240. DOI: `10.1515/crelle-2023-0096`. arXiv: `2301.07679`. Role: character-orthogonality reduction of product-of-primes residue questions to character sums over primes; modern prior-art anchor for PC-272's classification of fixed-upper prime-ratio exact-lattice statistics as a multiplicative-character autocorrelation.
- Cédric Pilatte, **Unconditional correctness of recent quantum algorithms for factoring and computing discrete logarithms**, *Forum of Mathematics, Pi* 14 (2026), e5. DOI: `10.1017/fmp.2025.10023`. Role: Proposition 3.9 and Appendix A connect prime-character sums to zero-free regions and the explicit formula for Dirichlet `L`-functions, with GRH giving almost square-root cancellation; prior-art anchor for PC-272's boundary that any critical-line sensitivity in this character-power packet is inherited Dirichlet-`L`/GRH data.