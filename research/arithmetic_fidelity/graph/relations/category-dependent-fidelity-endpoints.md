...
- [[research/arithmetic_fidelity/findings/AF-014-gram-compression-loses-only-global-orientation-at-full-rank|AF-014]] shows that full-rank Gram compression is complete modulo `O(d)` and loses only one global orientation bit relative to `SO(d)`.
