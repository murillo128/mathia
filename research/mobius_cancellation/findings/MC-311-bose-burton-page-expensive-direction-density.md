...
For the exact modern binary-matroid density formulation used in `(17)`, see the statement recorded as Theorem 4.1 (Bose–Burton) in Peter Nelson and Sergey Norin, *Dense binary PG(t−1,2)-free matroids have critical number t−1 or t*, Journal of Combinatorial Theory, Series B **127** (2017), 123–154, DOI `10.1016/j.jctb.2017.01.003`: density above `(1-2\cdot2^{-t})2^r` forces `PG(t-1,2)`.
