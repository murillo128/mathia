...
The missing bridge is now entirely arithmetic: once the mean-absolute estimate is proved on such a scale mesh, `MC-116` fills the physical-scale gaps and `MC-115` closes zero exclusion.
