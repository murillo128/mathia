...
- Peter J. Forrester and Bo-Jian Shen, **Finite size corrections in the bulk for circular beta ensembles**, *Forum of Mathematics, Sigma* 14 (2026), e105. DOI: `10.1017/fms.2026.10240`. Role: current general finite-size anchor for `VIS-039`; proves that general bulk `n`-point correlations for the classical circular ensembles `beta=1,2,4` have asymptotic expansions in powers of `1/N^2` and that these expansions lift to spacing distributions and their generating functions. It supports the even-power prior-art boundary but is not cited as a proof of the exact binned three-consecutive-spacing Janossy/cell expansion assumed conditionally in `VIS-039`.
...
- E. Bogomolny and J. P. Keating, **A method for calculating spectral statistics based on random-matrix universality with an application to the three-point correlations of the Riemann zeros**, *Journal of Physics A: Mathematical and Theoretical* 46:30 (2013), 305203. DOI: `10.1088/1751-8113/46/30/305203`. Role: finite-height three-point zeta prior-art boundary for `VIS-039`; gives a heuristic framework combining the universal random-matrix limit with non-universal trace-formula/small-prime contributions. It prevents interpreting finite-height three-point structure or a universal-plus-arithmetic decomposition as new, while leaving open the Mathia-specific transfer question for a binned three-consecutive-gap conditional statistic.
...
## Prime-geometric Dickman limits and local-limit boundary

- Chinmoy Bhattacharjee and Ilya Molchanov, **Convergence to scale-invariant Poisson processes and applications in Dickman approximation**, *Electronic Journal of Probability* 25 (2020), paper 79, 1–20. DOI: `10.1214/20-EJP482`; arXiv `1911.06229`. Role: decisive prior-art boundary for `VIS-081`. Their Theorem 3.6 treats exactly independent `Geom(1-1/p)` prime exponents at frequencies `log p` and proves convergence of the normalized prime-log sum to the standard Dickman distribution; Sections 4–5 give the randomly directed scale-invariant Poisson and multivariate Dickman framework. `VIS-081` contributes only the exact bridge from Mathia's signed Euler-product energy measure to the difference of two independent copies of this classical model and does not claim a new Dickman limit theorem.

- Régis de la Bretèche and Gérald Tenenbaum, **On strong and almost sure local limit theorems for a probabilistic model of the Dickman distribution**, *Lithuanian Mathematical Journal* 61:3 (2021), 301–311. DOI: `10.1007/s10986-021-09529-6`; arXiv `2012.00528`. Role: established local-limit boundary for `VIS-081`; proves strong and almost-sure local limit formulae for the classical Bernoulli Dickman model. It demonstrates that local Dickman approximation is established prior art in related models but does not supply the atom-separated shrinking-sinc-window local limit for Mathia's signed prime-log pure-point law.

## Path signatures, winding moments, and low-degree uniqueness

- Ben Hambly and Terry Lyons, **Uniqueness for the signature of a path of bounded variation and the reduced path group**, *Annals of Mathematics* 171:1 (2010), 109–167. DOI: `10.4007/annals.2010.171.109`. Role: standard bounded-variation path-signature and tree-like-equivalence reference for `VIS-095` and `VIS-096`; bounds any interpretation of full path-signature uniqueness as new.

- Horatio Boedihardjo, Hao Ni, and Zhongmin Qian, **Uniqueness of signature for simple curves**, *Journal of Functional Analysis* 267:6 (2014), 1778–1806. DOI: `10.1016/j.jfa.2014.06.006`; arXiv `1304.0755`. Role: decisive planar prior-art boundary for `VIS-096`. Corollary 2 states that the first four terms of the log signature of a closed planar finite-`p`-variation curve, `1<=p<2`, are determined by its winding-number function, and the paper shows that degree four is sharp because equal winding functions can coexist with different fifth signature terms. `VIS-096` only specializes this classical boundary after proving that a fixed two-coordinate delay path's local three-block inventory fixes the oriented polygonal current and therefore the winding function of its chord closure.
...
- Weikang Qian, Marc D. Riedel, and Ivo Rosenberg, **Uniform approximation and Bernstein polynomials with coefficients in the unit interval**, *European Journal of Combinatorics* 32:3 (2011), 448–463. DOI: `10.1016/j.ejc.2010.11.004`. Role: explicit classical anchor for conversion between power-form and Bernstein-form polynomial coefficients, used to delimit the basis-conversion step in `VIS-437`; the exact threshold-tail coefficient sum and Wang Wiener specialization are derived here and no general basis-conversion novelty is claimed.

- Wassily Hoeffding, **Probability Inequalities for Sums of Bounded Random Variables**, *Journal of the American Statistical Association* 58:301 (1963), 13–30. DOI: `10.1080/01621459.1963.10500830`. Role: classical concentration inequality used in `VIS-432` to bound the binomial tails of a thresholded Bernstein coefficient sequence by `exp(-d(b-a)^2/2)`; the finding claims no novelty for Hoeffding concentration or general Bernstein approximation.

- Herman Chernoff, **A Measure of Asymptotic Efficiency for Tests of a Hypothesis Based on the Sum of Observations**, *The Annals of Mathematical Statistics* 23:4 (1952), 493–507. DOI: `10.1214/aoms/1177729330`. Role: classical exponential-moment and hypothesis-testing source for the Bernoulli Chernoff/KL separator optimized in `VIS-433`; the finding claims no novelty for Chernoff bounds, relative entropy, or Chernoff information.

- A. Bhattacharyya, **On a measure of divergence between two statistical populations defined by their probability distributions**, *Bulletin of the Calcutta Mathematical Society* 35 (1943), 99–109. MR0010358. Role: classical source for the Bhattacharyya coefficient/distance used in `VIS-435`; the finding only specializes the symmetric affinity to Bernoulli square-root/arcsine coordinates and claims no new statistical-distance or information-geometry theorem.

- Frank Nielsen, **An Information-Geometric Characterization of Chernoff Information**, *IEEE Signal Processing Letters* 20:3 (2013), 269–272. DOI: `10.1109/LSP.2013.2243726`. Role: information-geometric prior-art anchor for `VIS-434`; characterizes Chernoff information geometrically for exponential families including multinomial families. `VIS-434` claims no new Chernoff/Fisher theorem and uses only the elementary local Bernoulli specialization to audit the squared-amplitude buffer coordinate.
