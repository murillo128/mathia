...
- John B. Conway, **Functions of One Complex Variable I**, 2nd ed., Graduate Texts in Mathematics 11, Springer (1978). DOI: `10.1007/978-1-4612-6313-5`. Role: Chapters 7 and 11 provide the classical maximum-modulus and harmonic-function/harmonic-conjugate machinery used in `VIS-016`. The finding's uniqueness statement is the elementary regular-disk consequence that two holomorphic functions with the same interior zeros and the same full boundary modulus differ only by a unimodular constant; no novelty is claimed for this complex-analysis fact.
