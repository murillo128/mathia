...
- Scheduled mathematical research watches routed through `.agents/skills/mathia-research-watch/SKILL.md` are an explicit exception: they may commit only substantive research-evidence updates directly to the default branch when that skill's path and publication gates pass.
