    ...
    for i, m, n in CRT_SPECS:
        ...
        if coprime:
            tasks = [
                ...
                _task("T3", "coupled-coordinate", "far", f"How many residues x modulo {modulus} satisfy (x mod {m}) + {relation_weight}(x mod {n}) = {relation_target}?", "int"),
            ]
            ...
            tasks = [
                ...
                _task("T4", "coupled-coordinate", "far", f"How many residues x modulo {modulus} satisfy (x mod {m}) + {relation_weight}(x mod {n}) = {relation_target}?", "int"),
            ]
