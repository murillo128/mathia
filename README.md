...
- `docs/THREE_LAYER_RESEARCH_SYSTEM.md` records the emerging hypothesis of a scarce frontier research director coordinating abundant local conceptual and formal specialists, while keeping the idea explicitly provisional and testable by ablation.
