...
- `docs/FORMAL_OPEN_CONJECTURES.md` explores formalized open conjectures as a validation substrate for conceptually useful, falsifiable, and formally checkable mathematical intermediate progress, while keeping semantic fidelity, conceptual fertility, formalization, and proof success as separate signals.
